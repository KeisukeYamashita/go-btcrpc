...
func TestGetBalance(t *testing.T) {
	...
	Convey("Success", t, func() {
		...
		So(err, ShouldBeNil)
		So(result, ShouldEqual, "0000000000000000008b57c8da52c30aa81909902793e6144a268aad59de3176") // Block Height
	})

	Convey("No addresss", t, func() {
		_, err := c.GetBalance("I do not exists")
		So(err, ShouldBeNil)
...
func TestGetBlock(t *testing.T) {
	...
	c := NewRPCClient(os.Getenv("BTCD_ENDPOINT"), basicAuth)
	Convey("Success", t, func() {
		block, err := c.GetBlock("0000000000000000008b57c8da52c30aa81909902793e6144a268aad59de3176")
		So(err, ShouldBeNil)
		So(block.Hash, ShouldEqual, "0000000000000000008b57c8da52c30aa81909902793e6144a268aad59de3176")
		So(block.Txs[0], ShouldEqual, "8878522366f6a4d9a7b4a88dca6d36b036f09d6093c1d39b8cf7bedd4dbf75d6")                // First transaction
		So(block.Txs[len(block.Txs)-1], ShouldEqual, "abb3880f8f7d66effa540e8ca9ce8878e8b4978c9843ee8c3001c07d09ae5ce3") //Last transcation
	})
